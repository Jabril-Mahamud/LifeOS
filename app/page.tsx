      ...
      <main className="min-h-[70vh] md:min-h-[85vh] flex flex-col items-center justify-start md:justify-center px-4 pt-12 md:pt-0">
        <div className="max-w-[75rem] w-full mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-card p-6 rounded-lg shadow-sm hover:shadow-md hover:scale-105 hover:ring-2 hover:ring-purple-500 hover:bg-purple-50/50 dark:hover:bg-purple-900/20 transition-all duration-300 cursor-pointer">
