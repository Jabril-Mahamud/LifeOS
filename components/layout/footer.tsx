export function Footer() {
  return (
    <footer className="max-w-[75rem] w-full mx-auto pt-6 border-t flex justify-between pb-24">
      <a
      ...
      <ul className="flex gap-2 ml-auto">
        <li>
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 font-medium text-[0.8125rem] rounded-full px-3 py-2 hover:bg-muted"
          >
            Clerk Docs{" "}
            <svg
              width="16"
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <rect x="2" y="2" width="12" height="12" rx="3" fill="currentColor" className="text-muted" />
              <path
