...
export function ProjectDetail({ project, tasks: initialTasks, stats: initialStats }: ProjectDetailProps) {
  ...
  const renderTaskItem = (task: Task) => (
    ...
    >
      <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            aria-label={`Mark task as ${task.status === "completed" ? "pending" : task.status === "pending" ? "in progress" : "completed"}`}
          >
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div>
                <div className="text-xl font-semibold">
                  {stats.taskStatusCount.pending}
                </div>
                <div className="text-xs text-muted-foreground">Pending</div>
              </div>
              <div>
                <div className="text-xl font-semibold">
                  {stats.taskStatusCount.inProgress}
                </div>
                <div className="text-xs text-muted-foreground">In Progress</div>
              </div>
              <div>
                <div className="text-xl font-semibold">
                  {stats.taskStatusCount.completed}
                </div>
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div>
                <div className="text-xl font-semibold text-red-500">
                  {stats.taskPriorityCount.high}
                </div>
                <div className="text-xs text-muted-foreground">High</div>
              </div>
              <div>
                <div className="text-xl font-semibold text-amber-500">
                  {stats.taskPriorityCount.medium}
                </div>
                <div className="text-xs text-muted-foreground">Medium</div>
              </div>
              <div>
                <div className="text-xl font-semibold text-blue-500">
                  {stats.taskPriorityCount.low}
                </div>
          ...
          <div className="flex justify-between items-center">
            <TabsList>
              ...
              <TabsTrigger value="pending">
                Pending ({stats.taskStatusCount.pending})
              </TabsTrigger>
              <TabsTrigger value="in-progress">
                In Progress ({stats.taskStatusCount.inProgress})
              </TabsTrigger>
              <TabsTrigger value="completed">
                Completed ({stats.taskStatusCount.completed})
              </TabsTrigger>
            </TabsList>
